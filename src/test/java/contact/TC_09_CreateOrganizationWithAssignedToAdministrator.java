...
public class TC_09_CreateOrganizationWithAssignedToAdministrator {
public static void main(String[] args) throws Throwable {
	...
	WebDriver driver = null;
		...
		//String assignedGroup="Administrator";
		String contactName = excelData.getDataFromExcelSheet("Sheet1", 5, 2);
		...
		String assignedTo = excelData.getDataFromExcelSheet("Sheet1", 5, 4);
